...
import { User, Building2, Heart, TrendingUp, GraduationCap, BookOpen, Send, CreditCard, Shield } from 'lucide-react';
...
const QuickActions = () => {
  ...
  return (
    <div className="bg-gray-900 border-t border-gray-800 hidden sm:block">
