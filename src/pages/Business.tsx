...
import { ArrowLeft, Building, CreditCard, Users, BarChart3, FileText, Calculator } from 'lucide-react';
...
const Business = () => {
  const coreFeatures = [
    { icon: Building, title: "Business Account", description: "Multi-currency business banking with global reach" },
    { icon: FileText, title: "Invoicing", description: "Professional invoicing with automated reminders" },
    { icon: Calculator, title: "Payroll", description: "Streamlined payroll management for your team" }
  ];
  ...
  const addOnFeatures = [
    ...
    { icon: CreditCard, title: "Expense Management", description: "Track and categorize business expenses" }
  ];
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Comprehensive business banking solutions with advanced tools for modern enterprises.
            </p>
          </div>

          {/* Core Features */}
          <div className="mb-16">
            <h2 className="text-3xl font-light text-center mb-12">Core <span className="text-[#ffd700]">Features</span></h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-gray-300 mb-6">
                      ...
                      higher limits, and exclusive business opportunities.
                    </p>
                  ...
                  <div className="text-center">
                    <div className="w-32 h-32 bg-[#ffd700] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-6">
                      <CreditCard className="w-16 h-16 text-[#ffd700]" />
                    </div>
