...
import { ArrowLeft, Heart, Eye, FileCheck, TrendingUp, Users, Shield } from 'lucide-react';
...
const NonProfit = () => {
  const benefits = [
    ...
    },
    {
      icon: Users,
      title: "Donor Portal",
      description: "Dedicated portal for donors to track their contributions and impact"
    },
    {
      icon: Shield,
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center">
                    <div className="w-32 h-32 bg-[#ffd700] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-6">
                      <Heart className="w-16 h-16 text-[#ffd700]" />
                    </div>
